...
# gears-cli run --host rgcluster --port 30001 set_debug_key.py
gears-cli run --host rgcluster --port 30001 gears_pipeline_sentence_register.py --requirements requirements_gears_pipeline.txt
echo "NLP Pipeline registered."
gears-cli run --host rgcluster --port 30001 edges_to_graph_streamed.py --requirements requirements_gears_graph.txt
echo "edges_to_graph_streamed.py registered"
echo "10 seconds for cluster to recover"
sleep 10
gears-cli run --host rgcluster --port 30001 sentences_matcher_register.py --requirements requirements_gears_aho.txt
